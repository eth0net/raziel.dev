      ...
      view: {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                class: "example rzl-flex-col",
                children: [
                  { tag: "h2", content: "Manipulating DOM elements" },
                  {
                    tag: "p",
                    content:
                      "There are a number of ways you can use Rzl to " +
                      "manipulate the DOM, here are some examples."
                  },
                  {
                    tag: "pre",
                    children: [
                      {
                        tag: "code",
                        content:
                          "<span class='code-comment'>// Creating a simple " +
                          "element</span><br>" +
                          "let heading = rzl.addElement('h1', document.body, " +
                          "{ id: 'heading1', content: 'Hello World!' });<br>" +
                          "<br>" +
                          "<span class='code-comment'>// Finding an element" +
                          "</span><br>" +
                          "let found = rzl.findChild(document.body, 'h1', " +
                          "'heading1');<br>" +
                          "<br>" +
                          "<span class='code-comment'>// Destroying an " +
                          "element</span><br>" +
                          "rzl.destroyElement(found, document.body);<br>" +
                          "rzl.destroyChild(document.body, 'h1', 'heading1');" +
                          "<br><br>" +
                          "<span class='code-comment'>// Destroying child " +
                          "elements</span><br>" +
              ...
              },
              {
                ...
                children: [
                  { tag: "h2", content: "Building a User Interface" },
                  {
                    tag: "p",
                    content:
                      "You can also use Rzl to change the contents of " +
                    ...
                    children: [
                      {
                        tag: "code",
                        content:
                          "<span class='code-comment'>// Create a UI " +
                          "definition</span><br>" +
                          "let def = {<br>" +
                          ...
                          "    class: 'myClass1',<br>" +
                          "    children: [<br>" +
                          "      { tag: 'h1', id: 'heading1', class: " +
                          "'myClass2', content: 'UI Heading!' },<br>" +
                          "      {<br>" +
                          "        tag: 'div',<br>" +
                          "        style: {<br>" +
                          "          display: 'flex',<br>" +
                          ...
                          "        },<br>" +
                          "        children: [<br>" +
                          "          { tag: 'h2', content: 'Flexbox " +
                          "Heading' },<br>" +
                          "          { tag: 'p', content: 'Flexbox " +
                          "paragraph.' }<br>" +
                          "        ]<br>" +
                          "      }<br>" +
                          "    ]<br>" +
                          ...
                          "};<br>" +
                          "<br>" +
                          "<span class='code-comment'>// Create a class " +
                          "instance</span><br>" +
                          "let myUI = new rzl.UI(def, { pnode: document.body" +
                          " });<br>"
                      }
                    ]
                  }
                    ...
                    children: [
                      {
                        tag: "code",
                        content:
                          "<span class='code-comment'>// Capitalise the first" +
                          " letter of a string</span><br>" +
                          "let cap = rzl.capitalise('test'); " +
                          "<span class='code-comment'>// 'Test'</span><br>" +
                          "<br>" +
                          "<span class='code-comment'>// Gather the fields " +
                          "of a form by id</span><br>" +
                          "let fields = rzl.getFormFields(myForm);<br>" +
                          "<span class='code-comment'>// " +
                          "{ id1: field1, id2: field2 }</span><br>" +
                          "<br>" +
                          "<span class='code-comment'>// Get the largest " +
                          "number in an Array</span><br>" +
                          "let arr = [1, 5, 10];<br>" +
                          "let large = rzl.largestOf(arr); " +
                          "<span class='code-comment'>// 10</span><br>" +
                          "<br>" +
                          "<span class='code-comment'>// Get a random Array " +
                          "entry</span><br>" +
                          "let large = rzl.randomArrayItem(arr);<br>" +
                          "<br>" +
                          "<span class='code-comment'>// Generate random " +
                          "integers</span><br>" +
                          "let rng0 = rzl.rng0to(100); <span " +
                          "class='code-comment'>// 0 to 100</span><br>" +
                          "let rng1 = rzl.rng1to(100); <span " +
                          "class='code-comment'>// 1 to 100</span><br>" +
                          "<br>" +
                          "<span class='code-comment'>// Check for undefined " +
                          "variables</span><br>" +
                          "let out1 = rzl.undef(myVar); <span " +
                          "class='code-comment'>// true</span><br>" +
                          "let myVar = 'I am defined!';<br>" +
                          "let out2 = rzl.undef(myVar); <span " +
                          "class='code-comment'>// false</span><br>"
                      }
                    ]
                  }
                ]
                ...
                children: [
                  {
                    tag: "a",
                    content: "Repo",
                    props: { href: "https://github.com/raziel2244/rzl" }
                  },
                  {
                    tag: "a",
                    content: "Docs",
                    props: { href: "https://docs.raziel.dev" }
                  },
                  {
                    tag: "a",
                    content: "Gitter",
                    props: { href: "https://gitter.im/raziel2244/rzl" }
                  }
                ]
              }
            ]
        ...
        children: [
					...
					{ tag: "hr" },
          {
            ...
            children: [
                ...
                class: "card rzl-flex-row",
								props: {
									href: "mailto:info@raziel.dev?Subject=Website%20Enquiry"
								},
                children: [
									{
										class: "rzl-flex-col",
                    children: [
                      ...
                      { tag: "p", content: "Email me at info@raziel.dev" }
                    ]
                  },
                  { class: "iconify icon:ic:outline-email" }
                ]
              },
              {
								tag: "a",
								props: { href: "https://gitter.im/raziel2244" },
                class: "card rzl-flex-row",
                children: [
                  {
                    class: "rzl-flex-col",
                    children: [
                      { tag: "h2", content: "Gitter" },
                      { tag: "p", content: "Join my Gitter community" }
                    ]
                  },
                  { class: "iconify icon:fa-brands:gitter" }
                ]
              },
              {
								tag: "a",
								props: { href: "https://t.me/raziel2244" },
                class: "card rzl-flex-row",
                children: [
                  {
                    class: "rzl-flex-col",
                    children: [
                      { tag: "h2", content: "Telegram" },
                      { tag: "p", content: "Message me on Telegram" }
                    ]
                  },
                  { class: "iconify icon:ei:sc-telegram" }
                ]
              }
            ]
          }
